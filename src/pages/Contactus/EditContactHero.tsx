...
const EditContactHero = () => {
  const [loading] = useState(false);
  const { t } = useTranslation();
  const breadcrumbItems = [
    { text: t("breadcrumbs.contactUS"), link: routes.HARDWARE },
    { text: t("breadcrumbs.editContactUsHero") },
  ];
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="d-flex justify-content-center">
              <h1 className="fw-bold"> Edit Contact Hero Section </h1>
            </div>
            <Stack
              direction="vertical"
...
export default EditContactHero;

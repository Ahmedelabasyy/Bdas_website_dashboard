...
const EditSoftwareHero = () => {
  const [loading] = useState(false);
  const { t } = useTranslation();
  const breadcrumbItems = [
    { text: t("breadcrumbs.software"), link: routes.HARDWARE },
    { text: t("breadcrumbs.editSoftwareHero") },
  ];
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="d-flex justify-content-center">
              <h1 className="fw-bold"> Edit Software Hero Section </h1>
            </div>
            <Stack
              direction="vertical"
...
export default EditSoftwareHero;
